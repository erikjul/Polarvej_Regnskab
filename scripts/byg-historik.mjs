...
const OVERRIDES = [
  ...
  { aar: 2021, tekst: 'Polarvej 23', beloeb: 20000, konto: 80, nyTekst: 'Modtaget fremlejedepositum (Polarvej 23)' },
  ...
  { aar: 2022, tekst: 'Konto 07583224528328', konto: 85, nyTekst: 'Provenu Polarvej 62 til sælger (overdragelse til Jan Iversen)' },
  { aar: 2022, tekst: 'Overdragelsessum', konto: 85, nyTekst: 'Overdragelsessum Polarvej 62 (køber Jan Iversen)' },
